  ...
  return (
      ...
      <FabButton
        ...
        palette={{
          ...
          uiPositive: theme.positive,
          uiNegative: theme.negative,
          numberPositive: theme.positive,
          numberNegative: theme.negative,
          warning: '#B45309',
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: HOME_TEXT.screenTitle, fontWeight: '400', letterSpacing: -0.5 },
  headerTitleOverlay: { position: 'absolute', left: 0, right: 0 },
  headerToggle: { flexDirection: 'row', borderRadius: HOME_RADIUS.pill, overflow: 'hidden', borderWidth: 1 },
  headerToggleItem: {
    width: 42,
    height: 34,
    alignItems: 'center',
  ...
  heroLabel: { fontSize: HOME_TEXT.caption, fontWeight: '500' },
  heroLabelDot: { fontSize: HOME_TEXT.label, fontWeight: '500' },
  heroTitle: { minHeight: 40, fontSize: HOME_TEXT.sectionTitle, lineHeight: 20, fontWeight: '500', marginTop: 4 },
  heroBalanceLabel: {
  ...
  heroTodayLabel: { fontSize: HOME_TEXT.tiny, fontWeight: '700', letterSpacing: 0.5, textTransform: 'uppercase' },
  heroTodayDate: { fontSize: HOME_TEXT.caption, fontWeight: '600' },
  ...
  summaryLead: { fontSize: HOME_TEXT.caption, fontWeight: '700' },
  ...
  swipeIndicatorDot: { width: 6, height: 3, borderRadius: HOME_RADIUS.full },
  swipeIndicatorActive: { position: 'absolute', left: (SWIPE_INDICATOR_STEP - 20) / 2, width: 20, height: 3, borderRadius: HOME_RADIUS.full },
  summaryStrip: {
    flexDirection: 'row',
    marginTop: 0,
    paddingVertical: 10,
  ...
  centerName: { maxWidth: 132, fontSize: HOME_TEXT.caption, fontWeight: '700', marginBottom: 2, textAlign: 'center' },
  ...
  breadcrumbLink: { fontSize: HOME_TEXT.caption, fontWeight: '800' },
  breadcrumbSep: { fontSize: HOME_TEXT.body, fontWeight: '900' },
  breadcrumbCurrent: { flexShrink: 1, fontSize: 12.5, fontWeight: '700' },
  breadcrumbMeta: { borderWidth: 1, borderRadius: HOME_RADIUS.full, paddingHorizontal: 8, paddingVertical: 4 },
  ...
  splitName: { flex: 1, fontSize: HOME_TEXT.body, fontWeight: '500' },
  splitValue: { fontSize: HOME_TEXT.bodySmall, fontWeight: '800', flexShrink: 0 },
  progressTrack: { height: 6, borderRadius: HOME_RADIUS.full, overflow: 'hidden' },
  progressFill: { height: 6, borderRadius: HOME_RADIUS.full },
  ...
  countBadgeText: { fontSize: HOME_TEXT.caption, fontWeight: '800' },
